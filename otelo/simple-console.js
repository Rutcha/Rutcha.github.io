...
// from https://github.com/1j01/simple-console //
...
var con = new SimpleConsole({
	...
	placeholder: " escreve Javascript aqui ;)",
	storageID: "simple-console"
});
document.getElementById("console").appendChild(con.element);

con.logHTML(
	"<h2 style='color: goldenrod;'>Console Portátil</h2>"	
);
